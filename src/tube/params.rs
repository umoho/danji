...
impl TriodeParams {
    ...
    /// 12AU7 (ECC82) - 中增益前级管
    ///
    /// 12AU7 (ECC82) - Medium-gain preamp tube
    ...
    /// 12AT7 (ECC81) - 中高增益前级管
    ///
    /// 12AT7 (ECC81) - Medium-high gain preamp tube
    ...
    /// 6DJ8 (ECC88) - 低增益前级管
    ///
    /// 6DJ8 (ECC88) - Low-gain preamp tube
    ...
    /// 6L6GC - 束射四极管（作为三极管使用）
    ///
    /// 6L6GC - Beam tetrode (used as triode)
    ...
    /// 6550 - 功率五极管（作为三极管使用）
    ///
    /// 6550 - Power pentode (used as triode)
    ...
    /// EL34 - 功率五极管（作为三极管使用）
    ///
    /// EL34 - Power pentode (used as triode)
    ...
    /// KT88 - 功率五极管（作为三极管使用）
    ///
    /// KT88 - Power pentode (used as triode)
